...
<div align="center">
  <div style="width:100%;max-width:660px;border:1px solid #30363d;border-radius:10px;background:rgba(34,211,238,0.04);padding:14px 18px;text-align:left;margin:8px auto;">
    <a href="https://github.com/ivan99vera1-wq/nuestro-money" style="color:#22d3ee;font-weight:700;font-family:ui-monospace,Menlo,monospace;text-decoration:none;">◉ nuestro-money ★</a>
    <div style="color:#c9d1d9;margin-top:4px;font-size:14px;">Banca privada digital para parejas — una única cuenta compartida.</div>
    <div style="margin-top:8px;color:#8b949e;font-family:ui-monospace,Menlo,monospace;font-size:12px;">React · TypeScript · Vite · Tailwind · Supabase · PWA</div>
  </div>
  <div style="width:100%;max-width:660px;border:1px solid #30363d;border-radius:10px;background:rgba(34,211,238,0.04);padding:14px 18px;text-align:left;margin:8px auto;">
    <a href="https://github.com/ivan99vera1-wq/Solca-decoraciones" style="color:#22d3ee;font-weight:700;font-family:ui-monospace,Menlo,monospace;text-decoration:none;">◉ Solca-decoraciones</a>
    <div style="color:#c9d1d9;margin-top:4px;font-size:14px;">Web corporativa para una empresa de decoración en Paraguay.</div>
    <div style="margin-top:8px;color:#8b949e;font-family:ui-monospace,Menlo,monospace;font-size:12px;">Next.js · TypeScript · Tailwind</div>
  </div>
  <div style="width:100%;max-width:660px;border:1px solid #30363d;border-radius:10px;background:rgba(34,211,238,0.04);padding:14px 18px;text-align:left;margin:8px auto;">
    <a href="https://github.com/ivan99vera1-wq/parcial-atencion" style="color:#22d3ee;font-weight:700;font-family:ui-monospace,Menlo,monospace;text-decoration:none;">◉ parcial-atencion</a>
    <div style="color:#c9d1d9;margin-top:4px;font-size:14px;">Quiz interactivo de estudio — 34 preguntas con justificación y estadísticas en vivo.</div>
    <div style="margin-top:8px;color:#8b949e;font-family:ui-monospace,Menlo,monospace;font-size:12px;">HTML · CSS · JavaScript</div>
  </div>
</div>
...
<div align="center">
  ...
  <div style="margin-top:10px;font-family:ui-monospace,Menlo,monospace;font-size:13px;">
    <a href="https://github.com/ivan99vera1-wq" style="color:#22d3ee;text-decoration:none;">github.com/ivan99vera1-wq</a>
    <span style="color:#30363d;"> &nbsp;·&nbsp; </span>
    <a href="https://www.instagram.com/Ivanvera7_/" style="color:#22d3ee;text-decoration:none;">instagram.com/Ivanvera7_</a>
  </div>
</div>
